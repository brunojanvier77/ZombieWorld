...
namespace Fy.Characters {
	...
	public struct ZombieSkinData
	{
		...
		public ZombieSkinData(bool randomize = false) {
			if (!randomize) {
				this.eyeID = 0;
				this.bodyID = 0;
				this.hairColorID = 0;
				...
				this.bodyID = 0;
				this.hairColorID = Defs.colorPallets["human_hair"].GetLastID();
				this.bodyColorID = Defs.colorPallets["human_body"].GetLastID();
	...
	{
		/* Skin Data */
		public ZombieSkinData skinData { get; protected set; }
		...
		public Zombie zombie { get; protected set; }

		/* Skin size */
		public Vector2 size { get ; protected set; }

		public ZombieSkin(Zombie zombie) {
			this.zombie = zombie;
		...
		private Vector3 GetVisualPosition(float priority) {
			return this.zombie.movement.visualPosition + new Vector3(0, 0, priority);
		}
		...
		public void Randomize() {
			this.skinData = new ZombieSkinData(false);
		}
	}
}